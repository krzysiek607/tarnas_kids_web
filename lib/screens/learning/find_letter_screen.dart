...
class _FindLetterScreenState extends State<FindLetterScreen> with TickerProviderStateMixin {
  ...
  // ~100 przedmiotów dla różnych liter polskiego alfabetu
  final Map<String, List<LetterItem>> itemsByLetter = {
    'A': [LetterItem('🚗', 'Auto', 'A'), LetterItem('🍉', 'Arbuz', 'A'), LetterItem('🛩️', 'Awionetka', 'A'), LetterItem('🎨', 'Akwarela', 'A'), LetterItem('👼', 'Anioł', 'A')],
    'B': [LetterItem('🍌', 'Banan', 'B'), LetterItem('🎈', 'Balon', 'B'), LetterItem('🥦', 'Brokuł', 'B'), LetterItem('🐞', 'Biedronka', 'B'), LetterItem('⛄', 'Bałwan', 'B')],
    'C': [LetterItem('🍬', 'Cukierek', 'C'), LetterItem('🧅', 'Cebula', 'C'), LetterItem('🍪', 'Ciastko', 'C'), LetterItem('☁️', 'Chmura', 'C'), LetterItem('🧱', 'Cegła', 'C')],
    'D': [LetterItem('🏠', 'Dom', 'D'), LetterItem('🌳', 'Drzewo', 'D'), LetterItem('🚪', 'Drzwi', 'D'), LetterItem('🦖', 'Dinozaur', 'D'), LetterItem('🐬', 'Delfin', 'D')],
    'E': [LetterItem('🧝', 'Elf', 'E'), LetterItem('🔌', 'Elektryka', 'E')],
    'F': [LetterItem('🏳️', 'Flaga', 'F'), LetterItem('🎆', 'Fajerwerki', 'F'), LetterItem('🦩', 'Flaming', 'F'), LetterItem('📁', 'Folder', 'F')],
    'G': [LetterItem('⭐', 'Gwiazda', 'G'), LetterItem('🎸', 'Gitara', 'G'), LetterItem('🍄', 'Grzyb', 'G'), LetterItem('🍐', 'Gruszka', 'G'), LetterItem('🪿', 'Gęś', 'G')],
    'H': [LetterItem('🚁', 'Helikopter', 'H'), LetterItem('🍵', 'Herbata', 'H'), LetterItem('🎣', 'Haczyk', 'H')],
    'I': [LetterItem('💉', 'Igła', 'I'), LetterItem('🎪', 'Impreza', 'I')],
    'J': [LetterItem('🥚', 'Jajko', 'J'), LetterItem('🍎', 'Jabłko', 'J'), LetterItem('🦎', 'Jaszczurka', 'J'), LetterItem('⛵', 'Jacht', 'J')],
    'K': [LetterItem('🐱', 'Kot', 'K'), LetterItem('🔑', 'Klucz', 'K'), LetterItem('📖', 'Książka', 'K'), LetterItem('🦀', 'Krab', 'K'), LetterItem('🌸', 'Kwiat', 'K'), LetterItem('🐨', 'Koala', 'K')],
    'L': [LetterItem('🦁', 'Lew', 'L'), LetterItem('🍃', 'Liść', 'L'), LetterItem('🍭', 'Lizak', 'L'), LetterItem('🦊', 'Lis', 'L'), LetterItem('💡', 'Lampa', 'L')],
    'Ł': [LetterItem('🛶', 'Łódka', 'Ł'), LetterItem('🦢', 'Łabędź', 'Ł'), LetterItem('🥄', 'Łyżka', 'Ł')],
    'M': [LetterItem('🐭', 'Mysz', 'M'), LetterItem('🦋', 'Motyl', 'M'), LetterItem('🥕', 'Marchewka', 'M'), LetterItem('🐒', 'Małpa', 'M'), LetterItem('🍯', 'Miód', 'M')],
    'N': [LetterItem('🔪', 'Nóż', 'N'), LetterItem('🦏', 'Nosorozec', 'N'), LetterItem('✂️', 'Nożyczki', 'N'), LetterItem('🌙', 'Noc', 'N')],
    'O': [LetterItem('👀', 'Oczy', 'O'), LetterItem('🔥', 'Ogień', 'O'), LetterItem('✏️', 'Ołówek', 'O'), LetterItem('🐙', 'Ośmiornica', 'O'), LetterItem('🍊', 'Oranż', 'O')],
    'P': [LetterItem('🐕', 'Pies', 'P'), LetterItem('🐦', 'Ptak', 'P'), LetterItem('🍕', 'Pizza', 'P'), LetterItem('🎁', 'Prezent', 'P'), LetterItem('🐼', 'Panda', 'P'), LetterItem('🍊', 'Pomarańcza', 'P')],
    'R': [LetterItem('🐟', 'Ryba', 'R'), LetterItem('🌹', 'Róża', 'R'), LetterItem('🚀', 'Rakieta', 'R'), LetterItem('🤖', 'Robot', 'R'), LetterItem('🦞', 'Rak', 'R')],
    'S': [LetterItem('☀️', 'Słońce', 'S'), LetterItem('🐘', 'Słoń', 'S'), LetterItem('🦉', 'Sowa', 'S'), LetterItem('🧦', 'Skarpeta', 'S'), LetterItem('🧀', 'Ser', 'S')],
    'T': [LetterItem('🐅', 'Tygrys', 'T'), LetterItem('📺', 'Telewizor', 'T'), LetterItem('🚜', 'Traktor', 'T'), LetterItem('🌷', 'Tulipan', 'T'), LetterItem('🍓', 'Truskawka', 'T')],
    'U': [LetterItem('👂', 'Ucho', 'U'), LetterItem('😊', 'Uśmiech', 'U'), LetterItem('🎂', 'Urodziny', 'U')],
    'W': [LetterItem('💧', 'Woda', 'W'), LetterItem('🍇', 'Winogrona', 'W'), LetterItem('🐋', 'Wieloryb', 'W'), LetterItem('🐿️', 'Wiewiórka', 'W'), LetterItem('🌋', 'Wulkan', 'W')],
    'Z': [LetterItem('🦓', 'Zebra', 'Z'), LetterItem('⏰', 'Zegar', 'Z'), LetterItem('🦷', 'Ząb', 'Z'), LetterItem('🏰', 'Zamek', 'Z'), LetterItem('🐇', 'Zając', 'Z')],
    'Ż': [LetterItem('🐸', 'Żaba', 'Ż'), LetterItem('🦒', 'Żyrafa', 'Ż'), LetterItem('🐢', 'Żółw', 'Ż'), LetterItem('⛵', 'Żagiel', 'Ż')],
  };
